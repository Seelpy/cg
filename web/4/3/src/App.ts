...
class App {
    ...
    private updatePlayer(deltaTime: number) {
        if (this.keys['w']) this.player.moveTo(this.maze, deltaTime, Direction.Forward)
        if (this.keys['s']) this.player.moveTo(this.maze, deltaTime, Direction.Backward)
        if (this.keys['ArrowLeft']) this.player.rotateTo(deltaTime, Direction.Left)
        if (this.keys['ArrowRight']) this.player.rotateTo(deltaTime, Direction.Right)
        if (this.keys['a']) this.player.moveTo(this.maze, deltaTime, Direction.Left)
        if (this.keys['d']) this.player.moveTo(this.maze, deltaTime, Direction.Right)
    }
